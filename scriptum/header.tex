...
\lstset{
    belowskip=0pt  % Space after the lstlisting 
}
...
% removing dot after the section numbering as suggested by ChatGPT ("1.1. Section" -> "1.1 Section")
\makeatletter
\renewcommand{\@seccntformat}[1]{\csname the#1\endcsname\quad} % Removes the dot
\makeatother
...
\captionsetup{labelformat=simple}   % odstrani tecku za cislovanim tabulek a obrazku, tedy "Figure 1.1." -> "Figure 1.1"
