...
\lstinputlisting[caption=Solution: Hückel theory,language=Python]{codes/solutions/huckel.py}
...
\raggedbottom\begin{lstlisting}[language=Python, caption={DMC exercise code solution.}, label=code:dmc_solution]
    n = 2000;
    nmax = 5000;
    limits = [-20, 20]
    ts = 0.01
